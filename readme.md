...
let firstName: string = "Md Aslam Hossain Samrat"; // string type for name
...
let friends: string[] = ["Arafat", "Siam", "Mahim"]; // Array of strings
let rollNumbers: number[] = [101, 102, 103, 104]; // Array of numbers

// Tuple (fixed length array with specific types)
let ageAndName: [number, string] = [23, "Md Aslam Hossain Samrat"]; // Tuple containing a number and a string
```
...
const user = {
  id: 579416,
  name: { firstName: "Aslam", middleName: "Hossain", lastName: "Samrat" },
  contact: "01790866",
  address: "BD",
};
...
console.log(phoneNumber); // "01790866"
console.log(midName); // "Hossain"
```
...
```ts
const loggedInUser = {
  name: "Md Aslam Hossain Samrat",
  address: {
    city: "Barishal",
    road: "8200",
    presentAddress: "Bip Colony",
  },
};
...
**Md Aslam Hossain Samrat**  
Software Engineer & Lead Frontend Developer  
[Email me](email:aslamsamrat307@gmail.com)   
